    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "tempCustDocIds":"SAMPLE_TEXT"
                , "tempOptoutIds":"SAMPLE_TEXT"
                , "tempBlackListIds":"SAMPLE_TEXT"
                , "tempContactIds":"SAMPLE_TEXT"
                , "tempaddressIds":"SAMPLE_TEXT"
                , "tempGroupIds":"SAMPLE_TEXT"
                , "tempSubscriptionIds":"SAMPLE_TEXT"
                , "lockCount":"0"
