...
/**
 * Performance test for the CfsService entity.
 */
class CfsServiceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CfsService entity")
        ...
        .repeat(2) {
            ...
            .exec(http("Create new cfsService")
            ...
            .body(StringBody("""{
                ...
                , "tempVoiceSpecIds":"SAMPLE_TEXT"
                , "tempDataSpecIds":"SAMPLE_TEXT"
                , "lockCount":"0"
            ...
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_cfsService_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
                exec(http("Get created cfsService")
                .get("${new_cfsService_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created cfsService")
            .delete("${new_cfsService_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
