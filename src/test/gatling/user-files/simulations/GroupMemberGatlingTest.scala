...
/**
 * Performance test for the GroupMember entity.
 */
class GroupMemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the GroupMember entity")
        ...
        .repeat(2) {
            ...
            .exec(http("Create new groupMember")
            ...
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_groupMember_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
                exec(http("Get created groupMember")
                .get("${new_groupMember_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created groupMember")
            .delete("${new_groupMember_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
